i201 = room {
	...
	dsc = 'Перед Чёрным властелином появляется круглый портал, из которого усиленно махая крыльями вылетает летучая мышь.^-Какую новость принёс мне крылатый шпион?^-Мой повелитель! Узник сбежал из замка гоблинов!^-Что!?, - властелин вскочил с трона и ударил кулаком по подлокотнику, -доставить его живым или мёртвым!!',
    enter = function(s)
