...
kolodec = iobj {
    ...
    useit = function (s, w)
		...
		return 'Я набрал в руки горсть прохладной воды. Живительная влага наполнила меня, я стал чувствоваться себя лучше.';
    end,
	talk = function(s)
